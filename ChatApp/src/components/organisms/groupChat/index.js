...
const GroupChat = () => {
  ...
  useEffect(() => {
    const fetchGroup = async () => {
      try {
        const unsubscribeFn = await getGroupById.getGroupById(
          currentGroupDetails.id,
          (data) => {
