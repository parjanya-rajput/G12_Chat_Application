...
import { Animated, SafeAreaView, Text, View, TouchableOpacity, Image, ActivityIndicator } from 'react-native';
            ...
            >
                <View style={styles.profile}>
                    ...
                    <View style={styles.statusContainer}>
                        ...
                        <Text style={profile.is_online === 'true' ? styles.onlineStatusText : styles.offlineStatusText}>
